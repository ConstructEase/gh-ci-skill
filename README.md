...
|---|---|---|---|---|---|---|---|---|---|
| **T1 CI status** | gh-ci | 100% (5/5) | 147,295 (147,290–147,329) | 135,848 | 11,436 | 8 | 1,013 | 15.1 | 4 |
| | `gh` | 100% (5/5) | 68,622 (68,615–68,637) | 60,359 | 8,259 | 4 | 252 | 6.0 | 2 |
| | gh-axi | 100% (5/5) | 74,614 (74,604–74,622) | 63,481 | 11,129 | 4 | 274 | 6.5 | 2 |
| **T2 named-check wait** | gh-ci | 100% (5/5) | 267,146 (266,965–304,262) | 253,473 | 13,659 | 14 | 1,762 | 22.0 | 7 |
| | `gh` | 100% (5/5) | 103,391 (103,334–103,395) | 94,905 | 8,463 | 6 | 404 | 7.9 | 3 |
| | gh-axi | 100% (5/5) | 74,638 (74,630–74,673) | 63,508 | 11,126 | 4 | 189 | 5.9 | 2 |
| **T4 failing run log** | gh-ci | 100% (5/5) | 298,118 (265,792–361,004) | 264,124 | 20,519 | 14 | 1,986 | 27.6 | 7 |
...
| **T5 mergeability** | gh-ci | 100% (5/5) | 226,087 (147,236–305,314) | 213,503 | 12,572 | 12 | 1,516 | 20.3 | 6 |
...
| **T6 PR comments** | gh-ci | 100% (5/5) | 225,811 (147,313–228,858) | 212,919 | 12,880 | 12 | 1,667 | 19.6 | 6 |
...
total input is median; API calls are medians). The three actions are:
...
|---|---|---|---|
| T7 inline reply / C-ghci | 100%/100% → 100%/60% | 155,046 (155,030–192,261) → 126,733 (126,645–166,629) | 4 → 3 |
...
| T8 top-level comment / C-ghci | 80%/100% → 40%/100% | 147,032 (109,890–148,784) → 205,542 (159,710–246,104) | 4 → 5 |
...
| T9 resolve thread / C-ghci | 100%/100% → 100%/80% | 154,341 (154,053–229,011) → 125,978 (125,977–126,005) | 4 → 3 |
