...
| Task | Condition | Success | Total input tok (IQR) | cache_read | cache_write | input | output | Wall s | API calls | Tool calls |
|---|---|---|---|---|---|---|---|---|---|---|
| T7 inline reply | gh-ci | call 5/5; judge 5/5 | 155,046 (155,030–192,261) | 149,516 | 15,185 | 8 | 1,144 | 14.1 | 4 | 3 |
...
| T8 top-level comment | gh-ci | call 4/5; judge 5/5 | 147,032 (109,890–148,784) | 135,775 | 10,943 | 8 | 906 | 12.3 | 4 | 3 |
...
| T9 resolve thread | gh-ci | call 5/5; judge 5/5 | 154,341 (154,053–229,011) | 148,999 | 14,755 | 8 | 1,036 | 12.7 | 4 | 3 |
...
| Task | Condition | Success | Total input tok (IQR) | cache_read | cache_write | input | output | Wall s | API calls | Tool calls |
|---|---|---|---|---|---|---|---|---|---|---|
| T7 inline reply | gh-ci | call 5/5; judge 3/5 | 126,733 (126,645–166,629) | 121,382 | 17,952 | 6 | 1,006 | 11.9 | 3 | 2 |
...
| T8 top-level comment | gh-ci | call 2/5; judge 5/5 | 205,542 (159,710–246,104) | 188,968 | 16,173 | 10 | 1,821 | 21.8 | 5 | 4 |
...
| T9 resolve thread | gh-ci | call 5/5; judge 4/5 | 125,978 (125,977–126,005) | 108,550 | 17,441 | 6 | 833 | 10.5 | 3 | 2 |
